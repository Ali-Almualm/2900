...
urlpatterns = [
    ...
    path('api/toggle-slot-availability/', views.toggle_slot_availability, name='toggle_slot_availability'), 
    ...
    path('match/<int:match_id>/assign/', views.assign_match_participants, name='assign_match_participants'),
    path('match/<int:match_id>/results/', views.enter_match_results, name='enter_match_results'),
